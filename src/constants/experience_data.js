const data = [
{id:0,jobTitle:"Software Developer",dates:"July 2021 - Present",company:"ORACLE",role:"FullTime",duties:["Part of SCP dev team (A service communication proxy for 5G-Core Network).","Responsible for end to end backend development, from requirement analysis to development to unit and feature testing."]},
